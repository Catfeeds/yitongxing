		...
		<div class="page-content-wrapper">
			...
			<div class="page-content">
				...
				<ul class="page-breadcrumb breadcrumb">
					<li><a href="javascript:void(0);">语种管理</a> <i
						class="fa fa-circle"></i></li>
					<li><span class="active">语种管理</span></li>
				</ul>
				<!-- END PAGE BREADCRUMB -->
					...
					<div class="col-md-12">
						...
						<div class="portlet light bordered">
							<div class="portlet-title">
								<div class="caption">
									<span class="caption-subject font-green bold uppercase">语种管理</span>
								</div>
								<div class="actions">
										...
										<tbody>
											...
											<c:forEach items="${list}" var="list">
												<tr>
													...
													<td>${list.languageEng}</td>
													<td><c:if test="${list.hotLanguageId==0}">
															<font color="green">是</font>
														</c:if> <c:if test="${list.hotLanguageId==1}">
...
<script type="text/javascript">
		...
		$(function(){
			//菜单选中样式添加
	        $(".page-sidebar-menu").children("li[name='language']").addClass("open");
	        $(".page-sidebar-menu").children("li[name='language']").children("li[name='languageList']").children("a").children("span[class='arrow']").addClass("open");
	        $(".page-sidebar-menu").children("li[name='language']").children("ul").children("li[name='languageList']").addClass("active");
	        $(".page-sidebar-menu").children("li[name='language']").children("ul").css("display","block");
		})
